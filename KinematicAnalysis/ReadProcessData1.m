function [LabData]= ReadProcessData1(Filename)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
% plane
Coordinates (:,1:3:end) = [];                                                 %In our case we are eliminating the 2nd coordinate, and only keeping x and z (sagital plane)
...
for k = 1: NbCoordinates
    FilteredCoordinates (:,k) = (ResidualAnalysis (Coordinates (:,k), LabData.Frequency))/1000; %NAO ESTOU A CONSEGUIR POR A DEVOLVER O CUT-OFF FREQ.COMO OUTRA PARTE
end
