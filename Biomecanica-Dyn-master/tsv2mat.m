...
function [fp1,fp2,fp3]=tsv2mat(write_file,name_out,plot_f,Filename)
...
for i=1:n_fp
    ...
    force_file=[name_ori,num2str(i),'.tsv'];
...
if plot_f==1,
    figure;
    for i=1:6
        subplot(2,3,i);plot(fp1(:,i));
    end
    
    figure;
    for i=1:6
        subplot(2,3,i);plot(fp2(:,i));
    end
    
    figure;
    for i=1:6
        subplot(2,3,i);plot(fp3(:,i));
    end
    
    figure;
    subplot(1,3,1);plot(COP1_y,COP1_x,'*r')
    xlabel('COP y')
    ylabel('COP x')
    set(gca,'XDir','Reverse')
    grid on
    
    subplot(1,3,2);plot(COP2_y,COP2_x,'*r')
    xlabel('COP y')
    ylabel('COP x')
    set(gca,'XDir','Reverse')
    grid on
    
    subplot(1,3,3);plot(COP3_y,COP3_x,'*r')
    xlabel('COP y')
    ylabel('COP x')
    set(gca,'XDir','Reverse')
    grid on
